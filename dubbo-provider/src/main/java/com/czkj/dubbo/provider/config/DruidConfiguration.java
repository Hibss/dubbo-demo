package com.czkj.dubbo.provider.config;
 ...
 * 单数据库
 * @Author steven.sheng
 * @Date 2020/3/16/01612:04
 */
@Slf4j
@Configuration
@MapperScan(basePackages = "com.czkj.dubbo.provider.dao")
public class DruidConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.czkj.dubbo.api.entity");
