package com.czkj.dubbo.consumer.util;
...
public class JacksonUtil {
    ...
    public static Map<String, String> getJsonToMap(String jsonStr){
        ...
        Set<Map.Entry<String, Object>> setMap=jsonObject.entrySet();
...
//    }
    ...
    public static Map<String, String> getMapFromJsonString(String jsonStr) {
